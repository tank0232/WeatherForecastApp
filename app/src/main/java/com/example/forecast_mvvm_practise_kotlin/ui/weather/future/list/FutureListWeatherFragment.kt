...
import com.example.forecast_mvvm_practise_kotlin.data.db.LocalDateConverter
...
//        // TODO
    ...
    private fun initRecyclerView(items:List<FutureWeatherItem>){
      val groupAdapter = GroupAdapter<ViewHolder>().apply {
        ...
        recyclerView.apply{ layoutManager = LinearLayoutManager(this@FutureListWeatherFragment.context)
